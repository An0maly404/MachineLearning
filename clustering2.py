...
plt.title('Clusters Visualization (Train Data - Press Critics, PCA 2D)')
...
plt.figure(figsize=(10, 6))
plt.scatter(reduced_data[:, 0], reduced_data[:, 1], c=clusters, cmap='rainbow', alpha=0.7)
plt.title('Clusters Visualization (Train Data - User Critics, PCA 2D)')
plt.xlabel('Global Sales')
plt.ylabel('Critic Score')
plt.show()
...
plt.figure(figsize=(12, 8))
dendrogram(linked_test, truncate_mode='lastp', p=12, leaf_rotation=45., leaf_font_size=12.)
plt.title('Dendrogram for Agglomerative Clustering (User Data - Press Critics)')
plt.xlabel('Sample Index or (Cluster Size)')
plt.ylabel('Distance')
plt.axhline(y=100, color='r', linestyle='--')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.scatter(reduced_data_test[:, 0], reduced_data_test[:, 1], c=clusters_test, cmap='rainbow', alpha=0.7)
plt.title('Clusters Visualization (Test Data - User Critics, PCA 2D)')
plt.xlabel('Global Sales')
